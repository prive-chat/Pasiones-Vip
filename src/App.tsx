...
export default function App() {
  const { user, profile, loading, isRecovery: authIsRecovery } = useAuth();
  const location = useLocation();
  const isRecovery = window.location.search.includes('type=recovery') || window.location.hash.includes('type=recovery') || authIsRecovery;
