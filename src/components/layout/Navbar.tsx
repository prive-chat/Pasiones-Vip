    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-black/60 backdrop-blur-2xl">
      <div className="container mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        <Link to="/" onClick={handleHomeClick} className="flex items-center space-x-2 group shrink-0">
          ...
          <span className="text-lg sm:text-xl font-black tracking-tighter passion-text drop-shadow-sm truncate max-w-[180px] sm:max-w-none font-display italic transition-all group-hover:drop-shadow-[0_0_8px_rgba(230,0,0,0.5)]">PASIONES VIP</span>
        </Link>
